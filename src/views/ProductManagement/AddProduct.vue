        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-dialog title="多规格" :visible.sync="dialogFormVisible">
            <el-form :model="addSizeForm">
              <el-form-item label="规格" prop="goodsstandard" style="width:300px" :label-width="formLabelWidth">
              ...
              <el-form-item label="包装费" prop="packingexpense" :label-width="formLabelWidth">
                <el-input-number v-model="addSizeForm.packingexpense" :min="1" :max="40" label="描述文字"></el-input-number>
              </el-form-item>
